 ...
 //     },
  ...
  sweets: [
    ...
    },
	{
      ...
      consist:
        'Состав: кешью, кокосовая стружка, финик ОАЭ, арахисовая паста',
      kbju: '125 / 5/ 7 / 11 на 1 шт.',
	  isNew: true,
      isHit: false,
    ...
    },
	{
      ...
      shortDescription: '',
      description:
        'Наша Карамель понравится как взрослым, так и детям!/n' +
        'Полезная альтернатива классической карамели с большим количеством сахара/n' +
        'Идеальна как допинг к сырникам, запеканкам, каше, творогу и тд. А также можно просто лакомиться ложкой !',
