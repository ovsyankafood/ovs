export const localCatalog = {
  programs: [
    {
      ...
      description:
        'Рацион составлен таким образом, что позволяет избавиться от килограммов с сохранением оптимального баланса белков, жиров и углеводов. Это способствует стабильному функционированию организма даже в условиях экстренного похудения;-*-*OLD*',
      properties: 'Ккал 1200 (5 блюд)',
      priceProperties: [
        'за 1 день 1355 руб/день',
        'от 7 дней 1240 руб/день',
        'от 30 дней 1206 руб/день',
      ],
    },
    {
      id: 1101,
      ...
      priceProperties: [
        'за 1 день 1420 руб/день',
        'от 7 дней 1295 руб/день',
        'от 30 дней 1255 руб/день',
      ],
    },

    {
      ...
      priceProperties: ['Стоимость 1260 р/день'],
    },
    {
      id: 1002,
    ...
    },
    {
      ...
      priceProperties: [
        'за 1 день 1545 руб/день',
        'от 7 дней 1410 руб/день',
        'от 30 дней 1355 руб/день',
      ],
    },
    {
      id: 1004,
      ...
      priceProperties: [
        'за 1 день 1670 руб/день',
        'от 7 дней 1555 руб/день',
        'от 30 дней 1510 руб/день',
      ],
    },
    {
      id: 1005,
  ...
  pf: [
    {
      ...
      consist:
        'Состав: творог, мука рисовая, яйцо, сахарозаменитель инулин, соль',
      ...
      totalCost: 645,
      shortDescription:
        'Состав: творог, мука рисовая, яйцо, изюм светлый, сахарозаменитель инулин, соль',
      description:
    ...
    },
    {
      ...
      totalCost: 650,
      shortDescription:
        'Состав: филе куриного бедра, кунжут, копченая паприка, соль',
      description:
    ...
    },
    {
      ...
      imageinside: 'sirn.inside.jpg',
      consist:
        'Состав: творог, мука рисовая, яйцо, курага, мак, сахарозаменитель инулин, соль',
      kbju: '157/15/6/11 на 100 г',
    ...
    },
    {
      ...
      consist:
        'Состав: филе куриной грудки, филе куриного бедра, кабачок, лук, соль, специи',
      ...
      properties: 'КБЖУ 160/23/7/1 на 100 г',
      priceProperties: ['650 руб/12 шт.'],
    },
    {
      id: 21004,
      ...
      consist:
        'Состав: яйцо, шампиньоны, сыр эдам, лук, укроп, соль, подсолнечное масло',
    ...
    },
    {
      ...
      consist:
        'Состав: яйцо, творог, банан, клубника, аргентинский арахис сорта Runner, соль, подсолнечное масло',
  ...
  sweets: [
    {
      id: 5401,
      name: 'Сырок творожный с клубникой',
      kKal: '1 шт. (75г)',
      cost: 145,
      costSuffix: '',
      ...
      isNew: true,
      isHit: false,
      title: 'Сырок творожный с клубникой',
      amount: 1,
      totalCost: 145,
      shortDescription: '',
      description:
        'Вкус детства, тот самый любимый всеми сырок с нежной творожной начинкой и клубничной прослойкой. Только в нашем правильный полезный состав без крахмала и пальмового масла. А вместо шоколадной глазури- настоящий темный итальянский шоколад Ariba!',
      properties: 'КБЖУ на 75г (1 шт.)  201/8/13/13',
      priceProperties: ['145 руб/1 шт.'],
    },
    {
      id: 5402,
      name: 'Сырок творожный шоколадный',
      kKal: '1 шт. (65г)',
      cost: 145,
      costSuffix: '',
      ...
      isNew: true,
      isHit: false,
      title: 'Сырок творожный шоколадный',
      amount: 1,
      totalCost: 145,
      shortDescription: '',
      description:
        'Вкус детства, тот самый любимый всеми сырок с нежной творожной начинкой и насыщенным шоколадным вкусом . Только в нашем правильный полезный состав без крахмала и пальмового масла. А вместо шоколадной глазури- настоящий темный итальянский шоколад Ariba!',
      properties: 'КБЖУ на 65г (1 шт.)  197/8/13/12',
      priceProperties: ['145 руб/1 шт.'],
    },
    {
      id: 5501,
      ...
      consist: 'Состав: финик ОАЭ, кокосовые сливки, кокосовое масло ',
    ...
    },
    {
      ...
      totalCost: 320,
      shortDescription: '',
      description: 'Нежнейшие конфеты с изысканной кокосовой ноткой.',
      properties: 'КБЖУ на 27г (1 шт.)  125/5/7/11',
    ...
    },
    {
      ...
      kbju: '325/7/17/36 на 100 г',
      title: 'Пирожное Брауни',
      amount: 1,
      totalCost: 160,
      shortDescription: 'Шоколадное пирожное с мягкой сердцевиной',
      description:
        'Наш вариант классического десерта Брауни. Не содержит яиц, подходит как вегетарианцам, так и веганам.',
    ...
    },
    {
      ...
      description:
        'Нежнейшая начинка из кешью и кокосового молока тает во рту, а изысканный вкус черной смородины с клубникой дает нотку кислинки, создавая гармоничное послевкусие. Кешьюкейк не проходит термическую обработку и не содержит яиц, поэтому он подходит абсолютно всем. Даже вегетарианцам, веганам и сыроедам.',
    ...
    },
    {
      ...
      properties: 'КБЖУ на 100 г 198/7/6/29',
    ...
    },
    {
      ...
      description:
        'Наш вариант классического десерта Брауни. Этот торт украсит ваш праздник, станет необычной, вкусной и здоровой альтернативой магазинным тортам. Не содержит яиц, подходит как вегетарианцам, так и веганам.',
      properties: 'КБЖУ на 100 г 325/7/17/36',
    ...
    },
    {
      ...
      properties: 'КБЖУ на 100 г 365/8/27/23',
