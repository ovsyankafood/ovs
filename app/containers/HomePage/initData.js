export const catalog = {
  programs: [
    ...
    },
    {
      ...
      discountAmount2: 30,
      discountCost2: 1145,
	  menuHref:'https://drive.google.com/file/d/1sApipOYOdSsTfDgICudkNUxZntA2uVTY/view',
      shortDescription: 'В программе снижено количество углеводов, сделан акцент на полезных жирах и полноценных белках, за счёт чего происходит эффективное сжигание жировой прослойки.',
      description:
        'В рацион также включена детокс-вода',
	  vodasostav:'(0.3 л). Состав: лимон, мята, имбирь).',
      properties: 'БЖУ 1300 / 100 / 75 / 55 (*Среднее значение , зависит от рациона) ',
      priceProperties: [
	  ...
	  isNew: true,
      totalCost: 1200,
	  menuDetoxHrev:'https://drive.google.com/file/d/1sApipOYOdSsTfDgICudkNUxZntA2uVTY/view',
  ...
  bonus: [
    ...
    },
    {
      ...
      properties: 'Просто напишите нам и мы привезем сертификат в назначенное место и время.',
      priceProperties: [
        'Стоимость подарочного сертификата 1500 руб.'
      ]
    },
    {
      id: 9003,
      ...
      totalCost: 313,
      shortDescription: 'Не знаете, что подарить тому, у кого всё есть?',
      description:'🌱 С каждого заказа на ваш бонусный счет идёт накопление 5% от суммы чека. 🌱 Вы можете потратить накопленные бонусы, оплатив ими до 50%  заказа из всего ассортимента «Овсянки». 🌱 оформляя карту, вы становитесь членом «Овсянка club», приобщаетесь к культуре здорового питания. Для держателей карт доступны специальные акции и персональные предложения',
      properties: 'Карта бессрочная и может использоваться для всей семьи',
      priceProperties: [
        'Стоимость бонусной карты: 313 руб. единовременно '
      ]
    },
    {
      id: 9004,
      ...
      properties: 'Просто напишите нам и мы привезем сертификат в назначенное место и время.',
      priceProperties: [
        'Стоимость подарочного сертификата 2000 руб.'
      ]
    },
    {
      id: 9005,
      ...
      properties: 'Просто напишите нам и мы привезем сертификат в назначенное место и время.',
      priceProperties: [
        'Стоимость подарочного сертификата 10 000 руб.'
      ]
    }
  ],
  books: [
